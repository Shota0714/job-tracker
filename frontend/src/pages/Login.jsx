                    ...
                    <div className='col-11 col-sm-8 col-md-5 col-lg-4'>
                        <div className="card border-0 shadow-lg p-4 p-md-5" style={{ backgroundColor: '#1e293b', borderRadius: '16px', border: '1px solid rgba(255, 255, 255, 0.05)' }}>
                            <div className='text-center mb-4'>
                                ...
                                <h1 className='h3 mt-3 mb-1 fw-bold text-white'>Welcome Back</h1>
                                <p className='text-light opacity-75 small'>Log in to manage your job pipeline</p>
                            </div>
                            ...
                            <div className='text-center mt-4'>
                                <p className='text-light opacity-75 small mb-0'>
                                    ...
                                    <Link to='/signup' className='text-decoration-none fw-semibold' style={{ color: '#818cf8' }}>
                                        Sign Up
                                    </Link>
                                </p>
                            </div>
