        ...
        <div className='container d-flex min-vh-100 align-items-center justify-content-center'>
            <div className='row'>
                ...
                <div className='col-md-5'>
                    ...
                    <p className='mt-4'>
                        Take control of your work day with Job Manager - the simplest way to organize, track, and prioritize your jobs. Wether you're managing freelance gigs, client tasks, or team projects, our intuitive dashboard helps you stay focused and never miss a deadline. Add, update, and complete jobs with ease - all in one place.
                    </p>
